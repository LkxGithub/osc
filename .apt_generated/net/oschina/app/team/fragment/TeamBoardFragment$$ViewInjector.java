...
public class TeamBoardFragment$$ViewInjector {
  public static void inject(Finder finder, final net.oschina.app.team.fragment.TeamBoardFragment target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131362120, "field 'mRlWaitDo'");
    target.mRlWaitDo = view;
    view = finder.findRequiredView(source, 2131362126, "field 'mRlAll'");
    target.mRlAll = view;
    view = finder.findRequiredView(source, 2131362118, "field 'mTvName'");
    target.mTvName = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131362122, "field 'mRlWill'");
    target.mRlWill = view;
    view = finder.findRequiredView(source, 2131362124, "field 'mRlIng'");
    target.mRlIng = view;
    view = finder.findRequiredView(source, 2131362119, "field 'mTvDate'");
    target.mTvDate = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131362049, "field 'mIvAvatarView'");
    target.mIvAvatarView = (net.oschina.app.widget.AvatarView) view;
    view = finder.findRequiredView(source, 2131362123, "field 'mTvOutdate'");
    target.mTvOutdate = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131362125, "field 'mTvIng'");
    target.mTvIng = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131362127, "field 'mTvAll'");
    target.mTvAll = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131362121, "field 'mTvWaitDo'");
    ...
    view = finder.findRequiredView(source, 2131362136, "method 'onClick'");
    view.setOnClickListener(
      new android.view.View.OnClickListener() {
        @Override public void onClick(
          android.view.View p0
